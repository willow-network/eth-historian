...
// EIP-4844: KZG commitments are 48 bytes (BLS12-381 G1 compressed point).
// Constant matches `c_kzg::BYTES_PER_COMMITMENT` — vendored here so we
// don't pull in the c_kzg native dep; we only manipulate the bytes, never
// perform KZG cryptography in this crate.
...
use crate::portal_types::utils::bytes::{hex_decode, hex_encode};
